...
import { MdFormatListBulleted, MdPeopleOutline, MdHistory } from "react-icons/md";
import { NavLink, useLocation } from "react-router-dom";

const Sidebar = ({ open }) => {
  const sidebarData = [
    { path: "/itemlist", icon: MdFormatListBulleted, label: "Itemlist" },
    { path: "/userlist", icon: MdPeopleOutline, label: "Userlist" },
